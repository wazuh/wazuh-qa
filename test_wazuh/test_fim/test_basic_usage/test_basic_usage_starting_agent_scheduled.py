...
from packages.wazuh_testing.wazuh_testing.tools import FileMonitor, TimeMachine, check_apply_test, load_wazuh_configurations, PREFIX, \
    stop_wazuh_service_windows, start_wazuh_service_windows, start_wazuh_service_linux, stop_wazuh_service_linux
...
def test_modify_existing_files_starting_agent_scheduled(folder, file_list, filetype, content, checkers, tags_to_apply,
    ...
    # Jump to the next scan and monitor log
...
def test_delete_existing_files_starting_agent_scheduled(folder, file_list, filetype, content, checkers, tags_to_apply,
                                                        get_configuration, configure_environment):
    check_apply_test(tags_to_apply, get_configuration['tags'])
    scheduled = get_configuration['metadata']['fim_mode'] == 'scheduled'
