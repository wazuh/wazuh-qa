...
def test_move_file(file, file_content, tags_to_apply, source_folder, target_folder,
    ...
    create_file(REGULAR, os.path.join(source_folder, subdir), file, content=file_content)
    shutil.rmtree(os.path.join(target_folder, subdir), ignore_errors=True)
