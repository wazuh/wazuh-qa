...
@pytest.mark.parametrize('folder, filename, mode, content, triggers_event, applies_to_config', [
    ...
    (testdir1, "btestfile2.ignore", "wb", b"", False, 'ossec_sregex.*conf'),
    ...
    (testdir2, "another.ignore", "wb", b"other content", False, 'ossec_sregex.*conf'),
    (testdir2, "another.ignored", "wb", b"other content", True, 'ossec_sregex.*conf'),
    (testdir2_sub, "another.ignore", "wb", b"other content", False, 'ossec_sregex.*conf'),
    (testdir2_sub, "another.ignored", "wb", b"other content", True, 'ossec_sregex.*conf'),
    (testdir2, "another.ignored2", "w", "", True, 'ossec_sregex_1.conf'),
    (testdir2, "another.ignored2", "w", "", False, 'ossec_sregex_(2|3).conf')
])
