...
WINDOWS_CONFIGURATIONS_DIR = Path("C:", "Program Files (x86)", "ossec-agent")
WAZUH_WINDOWS_CONF  = Path(WINDOWS_CONFIGURATIONS_DIR, "ossec.conf")
WINDOWS_CLIENT_KEYS = Path(WINDOWS_CONFIGURATIONS_DIR, "client.keys")
WINDOWS_VERSION = Path(WINDOWS_CONFIGURATIONS_DIR, "VERSION")
WINDOWS_REVISION = Path(WINDOWS_CONFIGURATIONS_DIR, "REVISION")
# Binaries paths
