...
- Regex value comparison in test cluster sync ([#5845](https://github.com/wazuh/wazuh-qa/pull/5845)) \- (Tests)
...
- Fix test_cluster_master_logs_order.py test ([#5776])(https://github.com/wazuh/wazuh-qa/pull/5776) \- (Tests)
