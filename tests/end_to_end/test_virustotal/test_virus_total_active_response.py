...
configuration_playbooks = ['configuration_ar.yaml']
remove_threat_file_path = os.path.join(test_data_path, 'active_response_script', 'remove-threat.sh')
configuration_extra_vars = {'configuration_file': remove_threat_file_path}
events_playbooks = ['generate_events_ar.yaml']
