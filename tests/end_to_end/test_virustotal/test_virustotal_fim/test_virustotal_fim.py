...
def test_virustotal(configure_environment, configuration, metadata, get_dashboard_credentials, generate_events,
                    clean_alerts_index):
    """
     Test to scanning a file using FIM and then do a request to virustotal to check if it is malicious
    """
