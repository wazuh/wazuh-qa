...
daemons_handler_configuration = {'configuration': {'daemons': ['wazuh-modulesd'], 'ignore_errors': True}}
...
def test_remote_configuration(get_configuration, configure_environment, reset_ossec_log, daemons_handler_configuration, wait_for_gcp_start):
    '''
