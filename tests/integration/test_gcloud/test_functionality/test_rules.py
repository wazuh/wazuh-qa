...
conf_params = {'PROJECT_ID': global_parameters.gcp_project_id, 'SUBSCRIPTION_NAME': global_parameters.gcp_subscription_name,
...
def test_rules(get_configuration, configure_environment,
    ...
    for line in events_file:
        ...
        publish(global_parameters.gcp_project_id, global_parameters.gcp_topic_name, global_parameters.gcp_credentials_file, 1, line)
