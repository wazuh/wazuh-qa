...
test_authd_force_insert_yes_tests = load_tests(os.path.join(test_data_path, 'test_authd_force_insert_yes.yaml'))
...
@pytest.mark.parametrize('test_case', [case['test_case'] for case in test_authd_force_insert_yes_tests],
