...
```shell script
pip install pytest freezegun jsonschema pyyaml==5.3 psutil distro pywin32 pypiwin32 wmi pandas==0.25.3 pytest-html==2.0.1 numpydoc==0.9.2
```
...
```shell script
pip3 install distro freezegun jq jsonschema psutil pydevd-pycharm pytest pyyaml==5.3 pandas==0.25.3 pytest-html==2.0.1 numpydoc==0.9.2
```
