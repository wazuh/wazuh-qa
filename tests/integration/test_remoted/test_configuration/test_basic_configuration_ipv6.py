...
brief: The 'wazuh-remoted' program is the server side daemon that communicates with the agents.
       Specifically, this test will check that remoted starts correctly configuring an
       IPv6 address.
...
def test_ipv6_secure(get_configuration, configure_environment, restart_remoted):
    ...
    description: Check if 'wazuh-remoted' correctly starts using ipv6 values.
                 ...
                 used instead), checks if the configuration is the same as the API reponse. 
    ...
    assertions:
        - Verify that a warning message is logged when ipv6 and secure connection is set.
    ...
    expected_output:
        ...
        - r'WARNING: .* Secure connection does not support IPv6. IPv4 will be used instead.'
