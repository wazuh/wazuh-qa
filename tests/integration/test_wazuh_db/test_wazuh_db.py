...
def test_wazuh_db_messages_agent(configure_sockets_environment, connect_to_sockets_module, test_case: list):
...
def test_wazuh_db_create_agent(configure_sockets_environment, connect_to_sockets_module):
    ...
    test_wazuh_db_messages_agent(configure_sockets_environment, connect_to_sockets_module, test['test_case'])
