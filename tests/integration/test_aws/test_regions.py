...
from wazuh_testing.modules.aws.constants import AWS_SERVICES_DB_PATH, RANDOM_ACCOUNT_ID
...
# -------------------------------------------- TEST_SERVICE_PATH -------------------------------------------------------
t2_configurations_path = os.path.join(CONFIGURATIONS_PATH, 'service_configuration_regions.yaml')
t2_cases_path = os.path.join(TEST_CASES_PATH, 'cases_service_regions.yaml')
