...
t3_configurations_path = os.path.join(CONFIGURATIONS_PATH, 'configuration_with_only_logs_after.yaml')
t3_cases_path = os.path.join(TEST_CASES_PATH, 'cases_with_only_logs_after.yaml')
