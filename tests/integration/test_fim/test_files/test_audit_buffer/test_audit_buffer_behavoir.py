...
test_cases_path = os.path.join(TEST_CASES_PATH, 'cases_audit_buffer_values.yaml')
configurations_path = os.path.join(CONFIGURATIONS_PATH, 'configuration_audit_buffer_values.yaml')
