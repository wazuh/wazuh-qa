...
brief: These tests will check if the File Integrity Monitoring (`FIM`) system watches selected files
       and triggering alerts when these files are modified. In particular, they will check if
       `FIM` events are still generated when a monitored directory is deleted and created again.
