...
from wazuh_testing.fim import (LOG_FILE_PATH, create_registry, generate_params, create_file, modify_registry_value,
                               REGULAR, callback_detect_event, callback_real_time_whodata_started,
