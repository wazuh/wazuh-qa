...
from wazuh_testing.fim import SYMLINK, REGULAR, LOG_FILE_PATH, generate_params, create_file, change_internal_options,\
    check_time_travel, callback_detect_event, REQUIRED_ATTRIBUTES, CHECK_ALL, CHECK_SIZE, regular_file_cud
...
def extra_configuration_before_yield():
    ...
    create_file(SYMLINK, testdir, symlinkdir, target=testdir_target)
