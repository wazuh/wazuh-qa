...
tcase_ids = ["no_logformat_location_set"]
configurations_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'data',
                                   'invalid_localfile_config_no_log_format.yaml')
...
def test_invalid_localfile_config_no_log_format(get_files_list, create_file_structure_module, get_configuration,
