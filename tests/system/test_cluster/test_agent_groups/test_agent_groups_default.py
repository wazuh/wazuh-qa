...
from system import (check_agent_groups, check_agent_status, remove_cluster_agents, restart_cluster, clean_cluster_logs, check_keys_file,
                    AGENT_STATUS_NEVER_CONNECTED, AGENT_STATUS_ACTIVE, AGENT_NO_GROUPS)
...
def test_agent_default_group(agent_target, clean_cluster_environment, test_infra_managers, test_infra_agents, host_manager):
    '''
