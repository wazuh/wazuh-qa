...
test_cases_file_path = os.path.join(test_data_path, 'test_cases', 'cases_enabled.yaml')
ossec_log = os.path.join(gettempdir(), 'test_enabled', 'ossec.log')
...
def test_enabled(configure_environment, metadata, get_information):
    '''
    description: Check that active-response repeated_offenders is enabled in the agent.
