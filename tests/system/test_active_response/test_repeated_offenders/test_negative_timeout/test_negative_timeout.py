...
test_cases_file_path = os.path.join(test_data_path, 'test_cases', 'cases_negative_timeout.yaml')
ossec_log = os.path.join(gettempdir(), 'test_negative_timeout', 'ossec.log')
...
def test_negative_timeout(configure_environment, metadata, get_information):
    '''
    description: Check that active-response timeout does not accept negative values.

    test_phases:
        - Set a custom Wazuh configuration.
        - Check in the manager ossec.log file for error or warning messages.
