...
def pytest_runtest_makereport(item, call):
    ...
    if report.when == 'teardown':
        ...
        elif report.head_line == 'test_cluster_error_logs' and item.module.nodes_with_errors:
            extra.append(pytest_html.extras.html("<h1>Error logs</h1>"))
        ...
        # Attach wrong order logs per each node in the 'test_check_logs_order_workers' test.
            ...
            extra.append(pytest_html.extras.html("<h1>Wrong logs order</h1>"))
            # Keys are human/natural sorted.
