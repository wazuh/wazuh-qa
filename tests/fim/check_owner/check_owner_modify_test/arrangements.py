...
config = '<ossec_config><syscheck><directories check_all="yes" check_owner="no" realtime="yes">/fim_test</directories></syscheck></ossec_config>'
test_dir = "/fim_test"
...
try:
    ...
    os.system("useradd -N -u 1002 wazuh")
