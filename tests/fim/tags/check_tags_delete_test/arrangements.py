...
# append new config
config = '<ossec_config><syscheck><directories check_all="yes" tags="fim,entry test,[rare char$],*+ç=)(/&%$·@!\|#~½¬¬{[]}" realtime="yes">/fim_test</directories></syscheck></ossec_config>'
...
file = open("/fim_test/check_tags_file.txt","w")
