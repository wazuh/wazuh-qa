...
# append new config
config = '<ossec_config><syscheck><directories check_all="yes" check_sha256sum="no" realtime="yes">/fim_test</directories></syscheck></ossec_config>'
...
file = open("/fim_test/sha256_sum_file.txt","w")
