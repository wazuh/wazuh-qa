export const wazuhMenuButton = '.eui > .euiFlexGroup';
//region Menu
export const modulesButton = '.wz-menu-sections > :nth-child(1) > .euiButtonContent';
export const managementButton = '.wz-menu-sections > :nth-child(2) > .euiButtonContent';
export const agentsButton = '.wz-menu-sections > :nth-child(3) > .euiButtonContent';
export const toolsButton = '.wz-menu-sections > :nth-child(4) > .euiButtonContent';
export const securityButton = '.wz-menu-sections > :nth-child(6) > .euiButtonContent';
export const settingsButton = '.wz-menu-sections > :nth-child(7) > .euiButtonContent';
//endregion Menu
//region SubMenu
//region Modules
...
//endregion
//region Management
export const rulesButton = ':nth-child(1) > .euiSideNav > .euiSideNav__content > .euiSideNavItem--root > .euiSideNavItem__items > :nth-child(1) > .euiSideNavItemButton > .euiSideNavItemButton__content > .euiSideNavItemButton__label';
export const decodersButton = ':nth-child(1) > .euiSideNav > .euiSideNav__content > .euiSideNavItem--root > .euiSideNavItem__items > :nth-child(2) > .euiSideNavItemButton > .euiSideNavItemButton__content > .euiSideNavItemButton__label';
export const cdbListButton = ':nth-child(1) > .euiSideNav > .euiSideNav__content > .euiSideNavItem--root > .euiSideNavItem__items > :nth-child(3) > .euiSideNavItemButton > .euiSideNavItemButton__content > .euiSideNavItemButton__label';
export const groupsButton = ':nth-child(1) > .euiSideNav > .euiSideNav__content > .euiSideNavItem--root > .euiSideNavItem__items > :nth-child(4) > .euiSideNavItemButton > .euiSideNavItemButton__content > .euiSideNavItemButton__label';
export const configurationButton = ':nth-child(1) > .euiSideNav > .euiSideNav__content > .euiSideNavItem--root > .euiSideNavItem__items > :nth-child(5) > .euiSideNavItemButton > .euiSideNavItemButton__content > .euiSideNavItemButton__label';
export const statusButton = ':nth-child(2) > .euiSideNav > .euiSideNav__content > .euiSideNavItem--root > .euiSideNavItem__items > :nth-child(1) > .euiSideNavItemButton > .euiSideNavItemButton__content > .euiSideNavItemButton__label';
export const clusterButton = ':nth-child(2) > .euiSideNav > .euiSideNav__content > .euiSideNavItem--root > .euiSideNavItem__items > :nth-child(2) > .euiSideNavItemButton > .euiSideNavItemButton__content > .euiSideNavItemButton__label';
export const statisticsButton = ':nth-child(2) > .euiSideNav > .euiSideNav__content > .euiSideNavItem--root > .euiSideNavItem__items > :nth-child(3) > .euiSideNavItemButton > .euiSideNavItemButton__content > .euiSideNavItemButton__label';
export const logsButton = ':nth-child(2) > .euiSideNav > .euiSideNav__content > .euiSideNavItem--root > .euiSideNavItem__items > :nth-child(4) > .euiSideNavItemButton > .euiSideNavItemButton__content > .euiSideNavItemButton__label';
export const reportingButton = ':nth-child(2) > .euiSideNav > .euiSideNav__content > .euiSideNavItem--root > .euiSideNavItem__items > :nth-child(5) > .euiSideNavItemButton > .euiSideNavItemButton__content > .euiSideNavItemButton__label';
//endregion
//region Tools
export const apiConsoleButton = '.euiSideNavItem__items > :nth-child(1) > .euiSideNavItemButton';
export const rulesetTestButton = '.euiSideNavItem__items > :nth-child(2) > .euiSideNavItemButton';
//endregion
//region Security
export const usersButton = '.euiSideNavItem__items > :nth-child(1) > .euiSideNavItemButton';
export const rolesButton = '.euiSideNavItem__items > :nth-child(2) > .euiSideNavItemButton';
export const policiesButton = '.euiSideNavItem__items > :nth-child(3) > .euiSideNavItemButton';
export const rolesMappingButton = '.euiSideNavItem__items > :nth-child(4) > .euiSideNavItemButton';
//endregion
//region Settings
export const settingsApiConfigurationButton = '.euiSideNavItem__items > :nth-child(1) > .euiSideNavItemButton';
export const settingsModulesButton = '.euiSideNavItem__items > :nth-child(2) > .euiSideNavItemButton';
export const settingsSampleDataButton = '.euiSideNavItem__items > :nth-child(3) > .euiSideNavItemButton';
export const settingsConfigurationButton = '.euiSideNavItem__items > :nth-child(4) > .euiSideNavItemButton';
export const settingsLogsButton = '.euiSideNavItem__items > :nth-child(5) > .euiSideNavItemButton';
export const settingsAboutButton = '.euiSideNavItem__items > :nth-child(6) > .euiSideNavItemButton';
//endregion
//endregion
