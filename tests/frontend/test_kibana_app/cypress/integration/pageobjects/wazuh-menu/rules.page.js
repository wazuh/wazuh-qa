export const rulesButtonSelector = '[class="euiSideNavItem euiSideNavItem--trunk"]';
...
export const listPagesSelector = 'nav[class="euiPagination"]';
export const customRulesButtonSelector = '[class="euiButtonGroup euiButtonGroup--m"]';
