import { addSecurityInformationDataButton, addAuditingAndPolicyMonitoringDataButton, addThreatDetectionAndResponseDataButton } from '../pageobjects/settings/sample-data.page'
