...
from wazuh_testing.tools.logging import SimulatorLogger
...
class Agent:
    ...
    def _register_helper(self):
        ...
        SimulatorLogger.V("Registration - " +
        ...
        while self.stop_receive == 0:
            if is_tcp(sender.protocol):
                try:
                    ...
                    SimulatorLogger.V(f"Memory error, trying to allocate {data_len}.")
                    return
                except Exception:
                    return
            else:
            ...
            try:
                ...
                SimulatorLogger.V("Corrupted message from the manager. Continuing.")
    ...
    def create_keep_alive(self):
        ...
        try:
            ...
            SimulatorLogger.V("Error creating keep alive for the agent. Check if " +
    ...
    def send_event(self, event):
        if is_tcp(self.protocol):
            ...
            try:
                ...
                SimulatorLogger.V("Broken Pipe error while sending event. " +
                                "Creating new socket...")
                ...
                SimulatorLogger.V("Connection reset by peer. Continuing...")
        if is_udp(self.protocol):
