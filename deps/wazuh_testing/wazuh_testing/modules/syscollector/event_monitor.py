...
def check_module_startup_finished(file_monitor=None, timeout=T_5, prefix=SYSCOLLECTOR_PREFIX, update_position=True):
...
def check_scan_started(file_monitor=None, timeout=T_5, prefix=SYSCOLLECTOR_PREFIX, update_position=True):
